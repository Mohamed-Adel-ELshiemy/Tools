...
set_message_info -id RCEX-203 -limit 0
...
set_message_info -id PSYN-415 -limit 0
...
set_message_info -id UITE-406 -limit 0
...
set_message_info -id PNR-254 -limit 0
...
set SNPS_CPU_MEM_LOG_OUT [format $SNPS_CPU_MEM_LOG_FORMAT "CHILD_PROC: Router" $SNPS_CPUTIME $SNPS_CPUTIME_hr $SNPS_ELAPSED_TIME $SNPS_ELAPSED_TIME_hr $SNPS_MEMORY_Mb ]
 set fileId [open proc_end_6992 w 0600]
puts $fileId "/home/ahesham/Desktop/PnR and synthesis/pnr/route_route_group_6992.tcl $SNPS_CPU_MEM_LOG_OUT"
close $fileId
quit
